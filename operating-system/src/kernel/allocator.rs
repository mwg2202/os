...
use x86_64::VirtAddr;
use x86_64::structures::paging::{Mapper, Page, FrameAllocator, Size4KiB, PageTableFlags};
...
pub fn init(
    mapper: &mut impl Mapper<Size4KiB>, fa: &mut impl FrameAllocator<Size4KiB>,
    start_addr: usize, size: usize
